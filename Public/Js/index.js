...
$(function () {
	...
	// 		eval('var data = ' + data);
	// 		if (data.status) {
	// 			$('input[name=max]').val(data.savepath.max);
	// 			$('input[name=medium]').val(data.savepath.medium);
	// 			$('input[name=mini]').val(data.savepath.mini);
    //
	// 			$('#upload_img').fadeOut().next().fadeIn().find('img').attr('src', ROOT + '/Uploads/Pic/' + data.savepath.medium);
	// 		} else {
	// 			alert(data.msg);
	// 		}
	// 	}
