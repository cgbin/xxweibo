...
<head>
	...
	<link rel="stylesheet" href="/Public/Theme/<?php echo ($style); ?>/Css/edit.css" />
    	...
    	<div id='right'>
    		...
    		<div class='form hidden'>
    			<form action="<?php echo U('editFace');?>" method='post' enctype="multipart/form-data">
	    			<div class='edit-face'>
	    				<img src="
                        <?php if($user["face180"]): ?>/Uploads/Face/<?php echo ($user["face180"]); ?>
                        <?php else: ?>
                            /Public/Images/noface.gif<?php endif; ?>" width='180' height='180' id='face-img'/>
	    				<p>
    		...
    		<div class='form hidden'>
    			<form action="<?php echo U('editPwd');?>" method='post' name='editPwd'>
    				...
    				<p>
    					...
    					<input type="password" name='old' id="old" class='input'/>
    				</p>
    				<p>
