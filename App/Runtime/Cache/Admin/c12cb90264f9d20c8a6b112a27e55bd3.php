...
<body>
	...
	<div style='width:600px;text-align:center;margin : 20px auto;'>
		<form action="/weibo/Admin/User/sechUser" method='get'>
			检索方式：
			<select name="type">
	...
	<table class="table">
		...
		<?php else: ?>
			...
			<?php if(is_array($user)): foreach($user as $key=>$v): ?><tr>
					...
					<td width='80' align='center'>
						<img src="<?php if($v["face"]): ?>/weibo/Uploads/Face/<?php echo ($v["face"]); else: ?>/weibo/Public/Images/noface.gif<?php endif; ?>" width='50' height='50'/>
					</td>
					<td align='center'>
						<ul>
		...
		<tr height='50'>
			<td align='center' colspan='7'><?php echo ($page); ?></td><?php endif; ?>
	</table>
</body>
</html